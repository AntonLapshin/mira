...
export function miraRoot(projectRoot: string): string {
  return path.join(projectRoot, ".mira");
}

export function buildsDir(projectRoot: string): string {
  return path.join(miraRoot(projectRoot), "builds");
}
...
export function buildDirName(description: string): string {
